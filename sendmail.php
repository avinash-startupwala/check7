...
$content = new SendGrid\Content("text/html", "<html><body><h1>Dear $first_name</h1><a href=https://startupwala.herokuapp.com/confirmuser.php?key=$random_key&&email=$email>Activate your account</a></body></html>");
